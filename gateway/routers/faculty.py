...
async def delete_teacher(id: int, auth_result: str = Security(auth.verify_with_admin)):
...
async def update_teacher(id: int, teacher: dict, auth_result: str = Security(auth.verify_with_admin)):
...
async def get_lecture(id: int, auth_result: str = Security(auth.verify)):
...
async def get_lecture_list(auth_result: str = Security(auth.verify)):
...
async def create_lecture(lecture: dict, auth_result: str = Security(auth.verify_with_admin)):
...
async def delete_lecture(id: int, auth_result: str = Security(auth.verify_with_admin)):
...
async def get_exercise(id: int, auth_result: str = Security(auth.verify)):
...
async def get_exercise_list(auth_result: str = Security(auth.verify)):
...
async def create_exercise(exercise: dict, auth_result: str = Security(auth.verify_with_admin)):
...
async def delete_exercise(id: int, auth_result: str = Security(auth.verify_with_admin)):
